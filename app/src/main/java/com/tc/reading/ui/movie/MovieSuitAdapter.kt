...
class MovieSuitAdapter(private var appCtx: AppContext,
                       private var movieSuits: MutableList<PkVideoSuit>)
    : RecyclerView.Adapter<MovieSuitAdapter.VideoHolder>() {
    ...
    private val movieCategories = mutableListOf<LabelFilterItem>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoHolder {
        ...
        if (viewType == 0) {
            if (labelFilterView == null) {
                ...
                labelFilterAdapter = LabelFilterAdapter(appCtx, movieCategories)
